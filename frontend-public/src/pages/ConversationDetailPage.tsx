...
function ConversationForm({ conversation, members, isNewMode, id }: ConversationFormProps) {
  ...
  return (
    <div className="min-h-screen gradient-bg pt-24 pb-4">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 h-[calc(100vh-7rem)] flex flex-col">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          {isSaving && (
            <span className="text-sm text-primary-600/70 flex items-center gap-1">
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-24">
        <div className="text-center">
          <p className="text-primary-600/70 mb-4">ミーグリレポが見つかりません</p>
